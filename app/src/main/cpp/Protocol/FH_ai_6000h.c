...
char *FH_ai_6000hWifiSend(void)
{
    ...
    PUBLIC_JsonArrayLoading(cjson_array, 2, "capacitance", "double", FH_ai_6000hValue.Param[0].Cu, FH_ai_6000hValue.Param[0].C, "null");
    PUBLIC_JsonArrayLoading(cjson_array, 3, "Dielectric_loss", "double", "%", FH_ai_6000hValue.Param[0].DF, "null");
    PUBLIC_JsonArrayLoading(cjson_array, 4, "C2_capacitance", "double", FH_ai_6000hValue.Param[1].Cu, FH_ai_6000hValue.Param[1].C, "null");
    PUBLIC_JsonArrayLoading(cjson_array, 5, "C2_dielectric_loss", "double", "%", FH_ai_6000hValue.Param[1].DF, "null");
