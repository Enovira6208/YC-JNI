...
// CM2100D_C_ValueType CM2100D_C_Value;
// CM2100D_I_ValueType CM2100D_I_Value;
// CM2100D_H_ValueType CM2100D_H_Value;
// CM2100D_R_ValueType CM2100D_R_Value;

// char *
// CM2100DwifiSend(uint8_t cnt);
...
// {
//     CM2100DMessageType *recv = (CM2100DMessageType *)buff;
...
//  * @ 通过蓝牙发送数据
//  */
// char *CM2100DwifiSend(uint8_t cnt)
// {
//     char *str;
