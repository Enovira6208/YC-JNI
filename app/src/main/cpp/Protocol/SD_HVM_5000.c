...
char *SD_HVM_5000Send(void)
{
    ...
    PUBLIC_JsonArrayLoading(cjson_array, 2, "resistance", "double", SD_HVM_5000Value.Ruint_15s, SD_HVM_5000Value.resistance_15s, "null");
    PUBLIC_JsonArrayLoading(cjson_array, 3, "resistance", "double", SD_HVM_5000Value.Ruint_60s, SD_HVM_5000Value.resistance_60s, "null");
    PUBLIC_JsonArrayLoading(cjson_array, 4, "resistance", "double", SD_HVM_5000Value.Ruint_10min, SD_HVM_5000Value.resistance_10min, "null");
